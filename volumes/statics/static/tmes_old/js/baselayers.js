...
function getCommonBaseLayers(map){
    ...
    var osmLayer = L.tileLayer('https://tiles.emodnet-bathymetry.eu/osm/land_geography/inspire_quad/{z}/{x}/{y}.png', {
	attribution: 'Tiles from EMOdnet Bathymetry &copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
    });
