...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', '[]').replace("'", '').replace("[", '').replace("]", '').split(',') + ['localhost', 'localhost:3000', 'django', 'django:8000', 'twister', '192.168.1.78','150.178.42.78', 'iws.inkode.it', 'iws.ismar.cnr.it', 'pharos4mpas.tools4msp.eu', '*']
