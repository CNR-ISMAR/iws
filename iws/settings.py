...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', '[]').replace("'","").split(',') + ['localhost', 'django', 'django:8000', 'twister', '192.168.1.78','150.178.42.78', 'iws.ismar.cnr.it', 'pharos4mpas.tools4msp.eu']
