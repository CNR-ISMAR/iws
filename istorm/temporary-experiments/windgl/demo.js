...
mapboxgl.accessToken =
  "pk.eyJ1IjoiZ2lvcmdpb2lua29kZSIsImEiOiJjamc2N2tuY2Iwb2FkMnlybmtxeGdkMDBoIn0.AZ1FpIwae6bvh04c-FrDfg";
...
function initializeConfig(container, { style, layers }) {
  ...
  map.on("load", () => {
    const source = windGL.source("docs/wind/2019031012/tile.json");
