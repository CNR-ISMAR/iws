...
module.exports = createReactClass({
    ...
    _getGradientTexture: function _getGradientTexture() {
        ...
        // 512, 10 because these are the same dimensions webgl-wind uses for its
    ...
    _redraw: function _redraw() {
        ...
        this.props.locations.forEach(function each(location) {
            ...
            this._wind.addPoint(pixel[0], pixel[1], size, intensity);
        }, this);
        this._wind.update();
        this._wind.display();
    },
